...
{
       0,    31,    31,    41,    55,    67,    77,    80,    85,    96,
     107,   112,   119,   120,   131,   138,   145,   152,   163,   172,
     181,   182,   204,   228,   232,   243,   244,   250,   254,   259,
     264,   269,   274,   278,   282,   286,   292,   298,   302,   309,
     313,   319,   323,   329,   333,   339,   343,   347,   353,   357,
     361,   365,   369,   375,   379,   383,   389,   393,   397,   401,
     407,   411,   415,   421,   425,   431,   435,   440,   445,   450,
     455,   460,   467,   473
};
#endif
...
#line 131 "parser.y" /* yacc.c:1646  */
    {
							...
							static_cast< FuncParametro* >((yyval.node))->setName((yyvsp[0].tval));
...
#line 152 "parser.y" /* yacc.c:1646  */
    {
							...
							static_cast< FuncParametro* >((yyval.node))->setName((yyvsp[-4].tval));
...
#line 182 "parser.y" /* yacc.c:1646  */
    { 
					...
					if((yyvsp[-2].node) == NULL){
						(yyvsp[-2].node) = new DeclId((yyvsp[-3].tval));
					}else{
						static_cast< DeclId* >((yyvsp[-2].node))->add_back(new DeclId((yyvsp[-3].tval)));
					}

					DeclId *a = (DeclId*) (yyvsp[-2].node);

					for(int i = 0 ; i < (a->get_child()).size() ; i++){
						static_cast< ListaDeclVar* >((yyval.node))->add_var(static_cast< DeclId * >(a->get_child()[i]));
					}
...
#line 204 "parser.y" /* yacc.c:1646  */
    {
					...
					if((yyvsp[-2].node) == NULL){
						(yyvsp[-2].node) = new DeclId((yyvsp[-6].tval), (yyvsp[-4].tval));
					}else{
						static_cast< DeclId* >((yyvsp[-2].node))->add_back(new DeclId((yyvsp[-6].tval), (yyvsp[-4].tval)));
					}
